...
//     };
//   }, [socketVersion, userId, managerId]);
...
//       const isCurrentSelectedOrganizer =
//         selectedOrganizer &&
//         Number(selectedOrganizer.organizerId) === Number(target.organizerId);

//       if (!activeConversation || !isCurrentSelectedOrganizer) {
...
//                         title={`Video call ${item.organizerName}`}
//                       >
//                         <Phone size={15} />
//                       </button>
