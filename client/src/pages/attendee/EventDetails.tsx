...
//       {/* Bottom row: remaining + qty selector */}
...
//   // ── Book handler — calls Stripe checkout ─────────────────────────────────

//   const handleBook = async () => {
//     if (!hasSelection || isCheckingOut) return;

//     // Read attendeeId from localStorage (same pattern as rest of the project)
...
//     // Build ticket payload — include names + prices for Stripe line item labels
...
//         {/* ── HERO BANNER: image left, key info right ── */}
