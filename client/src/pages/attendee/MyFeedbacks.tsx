...
//         key={index}
//         size={18}
//         className={`feedback-star-icon ${filled ? "filled" : "empty"}`}
...
//           Review all the feedback you have submitted for your attended events.
//         </p>
//       </div>

//       <div className="stats-grid feedback-stats-grid">
//         <div className="surface-card feedback-stat-card">
//           <div className="feedback-stat-icon feedback-stat-icon-orange">
//             <MessageSquareText size={20} />
//           </div>
//           <div className="feedback-stat-content">
//             <span className="feedback-stat-label">Total Feedbacks</span>
//             <h3>{feedbacks.length}</h3>
//             <p>All feedback entries submitted from your attendee account.</p>
//           </div>
//         </div>

//         <div className="surface-card feedback-stat-card">
//           <div className="feedback-stat-icon feedback-stat-icon-gold">
//             <Star size={20} />
//           </div>
//           <div className="feedback-stat-content">
//             <span className="feedback-stat-label">Average Rating</span>
//             <h3>{feedbacks.length ? averageRating.toFixed(1) : "0.0"}</h3>
//             <p>Your average rating across all submitted event reviews.</p>
//           </div>
//         </div>
//       </div>
...
//               A complete list of the ratings and comments you shared.
//             </p>
//           </div>
...
//             <RefreshCw
//               size={16}
//               className={isRefreshing ? "refresh-feedbacks-icon spinning" : "refresh-feedbacks-icon"}
//             />
...
//             <p>Please wait while we fetch your submitted event feedbacks.</p>
//           </div>
//         ) : feedbacks.length === 0 ? (
//           <div className="my-feedbacks-state-box">
...
//             <p>You have not submitted any event feedback yet.</p>
//           </div>
//         ) : (
//           <div className="my-feedbacks-list">
//             {feedbacks.map((feedback, index) => (
//               <article
//                 key={`${feedback.eventName}-${feedback.createdAt}-${index}`}
//                 className="feedback-history-card"
//               >
//                 <div className="feedback-history-top">
//                   <div className="feedback-history-title-wrap">
//                     <h3 className="feedback-history-event-name">{feedback.eventName}</h3>

//                     <div className="feedback-history-meta-row">
//                       <div className="feedback-history-meta-pill">
//                         <Ticket size={15} />
...
//                   <div className="feedback-history-rating-box">
//                     <span className="feedback-history-rating-label">Your Rating</span>
//                     <div className="feedback-history-stars">
//                       {renderStars(Number(feedback.rating))}
//                     </div>
//                     <strong className="feedback-history-rating-number">
//                       {feedback.rating}/5
//                     </strong>
//                   </div>
//                 </div>

//                 <div className="feedback-history-comment-box">
//                   <span className="feedback-history-comment-label">Your Feedback</span>
//                   <p className="feedback-history-comment">{feedback.comment}</p>
//                 </div>
//               </article>
//             ))}
//           </div>
