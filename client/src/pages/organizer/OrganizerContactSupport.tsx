...
import "./OrganizerContactSupport.css";
import AlertSnackbar from "../../components/common/AlertSnackbar";
import { useAlert } from "../../hooks/useAlert";
import { sendSupportToAdmin } from "../../api/eventApi";
...
const SUPPORT_SUBJECTS = [
  "Event Approval Issue",
  "Venue Request Problem",
  "Ticket Setup Assistance",
  "Announcement or Dashboard Issue",
...
const OrganizerContactSupport: React.FC = () => {
      ...
      <div className="page-shell">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Reach out to the admin team for help with event management issues and platform-related concerns.
          </p>
        </div>
        ...
        <div className="surface-card contact-support-card">
          <div className="contact-support-header">
            ...
            <div>
              <h3 className="contact-support-section-title">Send a Support Request</h3>
...
export default OrganizerContactSupport;