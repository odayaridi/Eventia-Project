...
//   useEffect(() => {
//     const hasOpenModal = isCreateModalOpen || !!editingEvent;
...
const MyEvents: React.FC = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      showAlert("Rejected event deleted successfully.", "success");
