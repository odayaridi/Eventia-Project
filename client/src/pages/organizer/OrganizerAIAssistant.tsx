...
import "./OrganizerAIAssistant.css";
import { useAlert } from "../../hooks/useAlert";
import { askEventChatbot } from "../../api/eventApi";
...
const OrganizerAIAssistant: React.FC = () => {
    ...
    () => [
      {
        ...
        sender: "assistant",
        text: "Hello! I’m Eventia Event AI Support. Ask me anything about events, event creation, ticketing, and event-related platform features.",
      },
    ],
    []
  );
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const reply = await askEventChatbot(trimmedPrompt);
      ...
      setIsSending(false);
      const errorMessage =
        error instanceof Error ? error.message : "Failed to connect to Event AI Support.";
    ...
    <div className="page-shell">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Get instant answers about events, ticketing, and event-related platform features.
        </p>
      </div>
      ...
      <div className="surface-card ai-chat-container">
        <div className="ai-chat-header">
          <div className="ai-chat-header-info">
            ...
            <div>
              <h2>Eventia Event AI Support</h2>
        ...
        <div className="ai-chat-footer">
          <div className="ai-input-wrapper">
            <textarea
              ...
              placeholder={isTypingText ? "AI is typing..." : "Message Event AI..."}
              value={prompt}
...
export default OrganizerAIAssistant;