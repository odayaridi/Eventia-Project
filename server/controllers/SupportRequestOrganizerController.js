...
async resolveOrganizerController(req, res, next) {
  try {
    ...
    await this.supportRequestOrganizerService.resolveOrganizerService(id);
    ...
    if (email) {
                ...
                <tr>
                  <td style="padding:36px 30px 24px;">
                    ...
                    <p style="margin:0 0 20px; color:#4b5563;">
                      We are happy to inform you that your event organizer contact request has been reviewed and marked as resolved by the Eventia admin team.
                    </p>
      ...
      await sendMail(email, "Your Eventia organizer request has been resolved", html);
    }
