...
class SupportRequestAttendeeController {
 ...
 async resolveAttendeeController(req, res, next) {
  try {
    ...
    await this.supportRequestAttendeeService.resolveAttendeeService(id);
    ...
    if (email) {
                ...
                <tr>
                  <td style="padding:36px 30px 24px;">
                    ...
                    <p style="margin:0 0 20px; color:#4b5563;">
                      We are happy to inform you that your attendee contact request has been reviewed and marked as resolved by the Eventia admin team.
                    </p>
      ...
      await sendMail(email, "Your Eventia attendee request has been resolved", html);
    }
