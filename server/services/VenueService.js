...
class VenueService {
    ...
    // async createVenueService(newVenue) {
    //     const result = await this.venueRepo.createVenueRepo(newVenue);
    //     if (result.affectedRows !== 1) throw new HttpError("Error creating venue");
    ...
    // async updateVenueService(dto) {
    //     const result = await this.venueRepo.updateVenueRepo(dto);
    //     if (result.affectedRows !== 1) throw new HttpError("Venue not found or nothing to update");
    //     return dto;
    // }
